...
const Experience = () => {
  return (
    <section id="experience" className="py-20 bg-gradient-to-br from-slate-100 to-emerald-50">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-8 top-12 bottom-0 w-0.5 bg-gradient-to-b from-emerald-400 to-blue-500"></div>
            
            {/* Experience Card */}
            <div className="relative pl-20 pb-12">
              {/* Timeline Dot */}
              <div className="absolute left-6 top-8 w-4 h-4 bg-gradient-to-r from-emerald-500 to-blue-600 rounded-full border-4 border-white shadow-lg"></div>
              
              {/* Card */}
              <div className="bg-white rounded-xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 border border-slate-200 hover:border-emerald-200">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl text-emerald-600 font-semibold">Amdocs</p>
                    </div>
                  </div>
