  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 pt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-20 left-10 w-20 h-20 bg-yellow-400 rounded-full opacity-80 animate-pulse"></div>
        <div className="absolute top-40 right-20 w-16 h-16 bg-orange-400 rounded-lg rotate-45 opacity-70 animate-bounce"></div>
        <div className="absolute bottom-40 left-20 w-12 h-12 bg-pink-400 rounded-full opacity-60 animate-ping"></div>
        <div className="absolute top-60 left-1/4 w-8 h-8 bg-green-400 rounded-full opacity-50"></div>
        <div className="absolute bottom-60 right-1/4 w-6 h-6 bg-cyan-400 rounded-full opacity-40 animate-pulse"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <div className="mb-8">
              ...
              <h2 className="text-4xl lg:text-6xl font-bold bg-gradient-to-r from-yellow-400 via-orange-400 to-pink-400 bg-clip-text text-transparent mb-6">
                BURGU ABHILASH
              </h2>
            </div>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-3 mb-6">
              ...
              <h3 className="text-2xl lg:text-3xl text-white/90 font-semibold">
                ...
                <span className="text-yellow-400 ml-2">Amdocs</span>
              </h3>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <button 
                ...
                className="group bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-8 py-4 rounded-xl hover:from-yellow-500 hover:to-orange-600 transition-all duration-300 font-bold hover:scale-105 shadow-2xl hover:shadow-yellow-500/25"
              >
          ...
          <div className="lg:w-1/2 flex justify-center relative">
            ...
            <div className="relative">
              ...
              <div className="relative w-80 h-80 lg:w-96 lg:h-96">
                {/* Animated Border */}
                <div className="absolute inset-0 bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 rounded-full p-1 animate-spin" style={{ animationDuration: '8s' }}>
                ...
                <div className="absolute inset-0 animate-spin" style={{ animationDuration: '20s' }}>
                  ...
                  <div className="absolute top-1/2 -right-4 transform -translate-y-1/2 w-3 h-3 bg-pink-400 rounded-full shadow-lg"></div>
                  <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-cyan-400 rounded-full shadow-lg"></div>
                  <div className="absolute top-1/2 -left-4 transform -translate-y-1/2 w-3 h-3 bg-green-400 rounded-full shadow-lg"></div>
                </div>
              </div>
              
              {/* Background Glow Effects */}
              <div className="absolute -z-10 top-10 right-10 w-40 h-40 bg-yellow-400/20 rounded-full blur-3xl"></div>
              <div className="absolute -z-10 bottom-10 left-10 w-48 h-48 bg-pink-400/20 rounded-full blur-3xl"></div>
